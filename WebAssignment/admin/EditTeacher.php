...
<div style="float:left; width:500px; padding-left:10px; text-align:justify; "><!-- this is the content div -->
        <?php    //1.connect to database
              ...
              $query = "SELECT * FROM teachers_list WHERE Id =$_GET[id] ";
  ...
  ?>
        ...
        <form action="UpdateTeacher.php?id=<?php echo $_GET['id']?>" method="post">
        <table style=" width:500px; alignment-adjust:central">
           <tr>
            ...
            <tr>
                <td>Surname</td>
                <td style=" text-align:center;"><input type="text" name="surname" style="width:200px" value="<?php echo $teacher['Surname']; ?>"/></td>
            </tr>
            <tr>
                <td>First Name</td>
                <td style=" text-align:center"><input type="text" name="firstname" style="width:200px" value="<?php echo $teacher['Firstname']; ?>"/></td>
            </tr>
            <tr>
                <td>State</td>
                <td style=" text-align:center">
                    <select name="state" style="width:200px">
                        <option><?php echo $teacher['State']?></option>
                        <option> Kwara </option>
                        <option> Lagos </option>
                        <option> Kogi </option>
                    </select>
            ...
            <tr>
                ...
                value="<?php echo $teacher['Password']; ?>"/></td>
            </tr>
            <tr>
