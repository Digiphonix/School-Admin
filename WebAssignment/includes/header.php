...
<body>
       ...
       <div class="menu"><!-- this is the menu div -->
        ...
        <ul>
            ...
            <li>Contact Us</li> 
            <li style="padding-left: 500px;"><a href="login.php">Portal</a></li> 
         </ul>
          ...
          <!-- <div class="navigation"><!-- this is the horizontal navigation div
                ...
                <ul>
                    <li><a href="admin/registration.php">Register Student</a></li>
                    <li><a href="admin/student_list.php">Student List </a></li>
                    <li><a href="admin/register_teacher.php">Register Teacher</a></li>
                    <li><a href="admin/teachers_list.php">Teachers List</a></li>
